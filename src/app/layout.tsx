...
export const metadata: Metadata = {
  title: "Child - Premium Toys for Kids | Safe & Educational",
  description: "Shop premium, safe toys for children of all ages. Quality educational toys trusted by 50k+ families worldwide.",
  keywords: "toys for kids, educational toys, safe toys, children's toys, toy store",
  metadataBase: new URL("https://childtoys.com"),
  alternates: {
    canonical: "https://childtoys.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Child - Premium Toys for Kids",
    description: "Discover our carefully curated collection of safe, educational toys that bring joy and learning.",
    siteName: "Child",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766063997037-kqvszyxc.jpg",
        alt: "Child Premium Toys Collection"
      }
    ]
  },
  twitter: {
    ...
    title: "Child - Premium Toys for Kids",
    description: "Shop quality toys trusted by families worldwide",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766063997037-kqvszyxc.jpg"]
  }
};
